...
<!-- 货物详情 !-->
   ...
   <tbody>
       <c:forEach items="${list_cart}" var="cart">
            <tr>  
                 <td class="text-center" style="vertical-align: middle"><a href="listproduct?productid=${cart.getProductid()}" class="a" style="color: green">
                      <img style="text-align:center;width: 100px;height: 100px" src="${cart.getImage()}">
                  </a></td>
                  <td class="text-center" style="vertical-align: middle"> <a href="listproduct?productid=${cart.getProductid()}" class="a" style="color: green;text-decoration: none">
                      ${cart.getProductname()}
                  </a></td>
