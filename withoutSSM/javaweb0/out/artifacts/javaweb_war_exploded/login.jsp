...
<head>
	...
	<body class="text-center">
		<form style="position: absolute; left: 595px; width: 421px; top: 195px;" class="form-signin" action="login" onSubmit="return panduan()" name="form1" method="post">
			<h1 class="h3 mb-3 font-weight-normal" >请登录</h1>
            <!-- 标签判断是否出现 -->
			<!--   https://www.cnblogs.com/wanggd/archive/2013/05/14/3077086.html  传值取值知识点-->
			<c:if test="${requestScope.login_msg!=null}">
				<p  style="color: red" ><%=request.getAttribute("login_msg")%></p>
			</c:if>
